                ...
                <div class="col-lg-9 order-lg-last dashboard-content">
                    ...
                    @if(session()->has('success'))
                        <div class="alert alert-success" role="alert">
                            Hello, <strong>Porto customer!</strong> From your My Account Dashboard you have the ability to view a snapshot of your recent account activity and update your account information. Select a link
                            below
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p>{{ Session::get('c_name') }}<br>
                                        {{ Session::get('c_email') }}<br>
